            ...
            <div 
                ...
                style={{width: 180}} >
                    ...
                    <div className="card-body d-flex justify-content-between p-1 ">
                        <ShowBtn  setImgToModel={setImgToModel} setIsLoading={setIsLoading} />
                        <EditBtn setImgToEdit={setImgToEdit} />
                        <DeleteBtn setIsLoading={setIsLoading} flashMsg={flashMsg} setFlashMsg={setFlashMsg} changeState={changeState}/>
                    </div> 
            </div>
        </animated.div> )
    )
